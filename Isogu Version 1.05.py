...
boss_surface = pygame.image.load('pygame/Graphics/enemy1.png').convert_alpha()
...
def draw_game():
    ...
    boss_rect.y -= 2
    if boss_rect.bottom <= 0: boss_rect.top = WINDOW_HEIGHT
...
while True:
    ...
    if pygame.time.get_ticks() - score_update_time >= 1000 and main_menu == False:
        score += 1
        score_update_time = pygame.time.get_ticks()
    ...
    # change boss image to updated versio
